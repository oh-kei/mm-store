...
export default function NavRegionSelect({ regions = [] }: { regions?: HttpTypes.StoreRegion[] }) {
  ...
  return (
    <Popover className="relative">
      <Popover.Button className="flex items-center gap-2 hover:text-white transition-colors outline-none py-2">
      ...
      >
        <Popover.Panel className="absolute right-0 mt-4 w-64 bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-[100] overflow-hidden">
          <div className="py-2">
