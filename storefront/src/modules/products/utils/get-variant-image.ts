 ...
 */
export function getVariantImage(variant: HttpTypes.StoreProductVariant | undefined, product?: HttpTypes.StoreProduct): string | null {
  ...
  if (parentProduct.handle === "technical-long-sleeve-rashguard") {
  ...
  if (parentProduct.handle === "short-sleeve-t-shirt") {
