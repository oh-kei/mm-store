    ...
    >
      ...
      <div className={`absolute inset-0 ${isBig ? 'p-4 md:p-6' : 'p-3 md:pt-4 md:px-4 md:pb-3'} flex flex-col justify-end items-start z-50 pointer-events-none`}>
        ...
        <div className={`flex-wrap gap-2 pointer-events-auto relative z-50 ${isBig ? 'flex' : 'hidden md:flex'}`}>
          ...
          >
            <button className="inline-flex items-center justify-center rounded-md font-medium transition-all duration-300 focus:outline-none border border-gray-100 text-slate-900 hover:bg-maritime-navy hover:text-white hover:border-maritime-navy bg-white shadow-sm h-9 px-4 text-[0.7rem] md:text-sm">
              Customise
            </button>
          </LocalizedClientLink>
          <LocalizedClientLink 
