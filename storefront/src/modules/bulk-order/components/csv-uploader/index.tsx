...
export function CSVUploader({ onUpload }: CSVUploaderProps) {
  ...
  return (
    <div 
      {...getRootProps()} 
      className={`
        border-2 border-dashed rounded-[32px] p-16 text-center transition-all cursor-pointer
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        {error && (
          <div className="mt-4 p-4 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center gap-3 text-red-400 text-sm font-bold animate-in fade-in slide-in-from-top-2 duration-300">
            <AlertCircle size={18} />
            {error}
          </div>
        )}
